...
def banner():
    ...
    print(BRIGHT + GREEN)
    print(r" __   __                  _  ______                    _  ")
    print(r" \ \ / /                 | | | ___ \                  | | ")
    print(r"  \ V /   __ _  _ __   __| | | |_/ /  ___   _ __ ___  | |_")
    print(r"   \ /   / _` || '__| / _` | | ___ \ / _ \ | '_ ` _ \ | '_ \ ")
    print(r"   | |  | (_| || |   | (_| | | |_/ /| (_) || | | | | || |_) |")
    print(r"   \_/   \__,_||_|    \__,_| \____/  \___/ |_| |_| |_||_.__/ ")
...
def main():
    ...
    if number == "1":
        ...
        print(f"\n{BRIGHT}{RED}[*] 1,2,3 ёбаный ты олень. Других нет{RESET_ALL}")
        sleep(1)
        main()
...
def spam_handler():
    ...
    check_version()
    banner()
    print("Введите номер телефона пидораса")
    ...
    print("подрыв жопы активирован", end="\n")
    print(f"{BRIGHT}{RED}[*] Ctrl+Z для помилования {RESET_ALL}")
...
def check_internet():
    try:
        ...
        print(f"\n{BRIGHT}{RED}[*] Включи интернет, хацкер хуев!{RESET_ALL}")
        sleep(1)
        main()
    return
...
def check_version():
    ...
    if float(version) < float(get("https://raw.githubusercontent.com/cludeex/spammer/master/version.txt").text):
        print(f"\n{BRIGHT}{RED}[*] Обнови ебучий софт!{RESET_ALL}")
        sleep(1)
        main()
    return
